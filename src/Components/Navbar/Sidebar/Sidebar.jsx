  ...
  return (
    <div className="sidebar">
      ...
      <ul className="sidebar-list">
        ...
        <li onclick="window.location.href='/html/events.html';">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="icon icon-tabler icon-tabler-timeline-event-exclamation"
            width="24"
            height="24"
            viewBox="0 0 24 24"
            stroke-width="2"
        ...
        <li onclick="window.location.href='/html/healthTips.html';">
          <svg
            xmlns="http://www.w3.org/2000/svg"
